...
class NoMatchException : public WebException
{
   public:
    ...
    NoMatchException(std::string const& str) : WebException(str) {}
};
...
{
   public:
    RedirectHttpException(Http::Status http_code, std::string const& msg, std::string const& target)
        : HttpWebException(http_code, msg), tgt(target)
    {}
...
{
   public:
    SystemRedirectHttpException(std::string const& tgt)
...
{
   public:
    TemporaryRedirectHttpException(std::string const& tgt)
...
{
   public:
    PermanentRedirectHttpException(std::string const& tgt)
...
{
   public:
    InternalServerErrorHttpException(std::string const& msg)
