...
template <class SyncSvcT, class RequestT, class ResponseT>
inline bes::service::RpcHandler<SyncSvcT, RequestT, ResponseT>::RpcHandler(SyncSvcT* svc, ServerCompletionQueue* cq,
                                                                           PoolTracker* trk)
...
template <class SyncSvcT, class RequestT, class ResponseT>
inline void bes::service::RpcHandler<SyncSvcT, RequestT, ResponseT>::Proceed()
{
...
template <class SyncSvcT, class RequestT, class ResponseT>
inline bes::service::RpcHandler<SyncSvcT, RequestT, ResponseT>::~RpcHandler()
{
